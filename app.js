...
function sumArray(sumArr) {
  var sumOfValues = 0;
  for(var i = 0; i < 3; i++){
    sumOfValues = sum(sumOfValues,sumArr[i])[0];
  }
  var array = [sumOfValues, sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + sumOfValues + ' is their sum.'];
  console.log(array);
  return array;
}
...
function multiplyArray(multArr) {
  var productOfValues = 1;
  for(var i = 0; i < 3; i++){
    productOfValues = multiply(multArr[i],productOfValues)[0];
  }
  var array = [productOfValues, 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + productOfValues + '.'];
  console.log(array);
  return array;
